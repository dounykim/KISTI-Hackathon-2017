...
def 세부지역적용하기():
    ...
    출력리스트 = []
    크기 = len(데이터리스트)
    선택속성 = ['농가여자_P1','답_P0','대지_P0','남자인구_P1','기온_9월 20이상','농가여자_P2','기온_7월 25이상','전_P0','과수원_P0']
    선택속성색인 = []
...
def 데이터분석1():
    pass
데이터분석버튼1= ttk.Button(데이터분석기능,text='고위험지역',width=18,command=데이터분석1)
데이터분석버튼1.grid(column=1,row=1,sticky=W)

# 데이터 분석 버튼 2
def 데이터분석2():
    pass
데이터분석버튼2= ttk.Button(데이터분석기능,text='분석2',width=18,command=데이터분석2)
데이터분석버튼2.grid(column=2,row=1,sticky=W)

# 데이터 분석 버튼 3
def 데이터분석3():
    pass
데이터분석버튼3= ttk.Button(데이터분석기능,text='분석3',width=18,command=데이터분석3)
데이터분석버튼3.grid(column=3,row=1,sticky=W)

# 데이터 분석 버튼 4
def 데이터분석4():
    pass
데이터분석버튼4= ttk.Button(데이터분석기능,text='지도 내보내기',width=18,command=데이터분석4)
데이터분석버튼4.grid(column=4,row=1,sticky=W)

# 데이터 분석 버튼 5
def 데이터분석5():
    pass
데이터분석버튼5= ttk.Button(데이터분석기능,text='분석5',width=18,command=데이터분석5)
데이터분석버튼5.grid(column=5,row=1,sticky=W)
